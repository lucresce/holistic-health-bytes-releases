...
**Última versão documentada neste README:** `v1.0.0-rc.75`  
...
```bash
export HHB_VERSION=v1.0.0-rc.75   # ou a tag do latest release
...
```bash
export HHB_VERSION=v1.0.0-rc.75   # nova tag
docker pull ghcr.io/lucresce/holistic-health-bytes:${HHB_VERSION}
...
| Tag | Uso |
|-----|-----|
| `ghcr.io/lucresce/holistic-health-bytes:v1.0.0-rc.75` | versão pinada |
...
```bash
docker pull ghcr.io/lucresce/holistic-health-bytes:v1.0.0-rc.75
```
